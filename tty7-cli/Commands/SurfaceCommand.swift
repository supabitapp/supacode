...
extension SurfaceCommand {
  struct List: ParsableCommand {
    ...
    @Option(name: [.short, .long], help: "Worktree ID. Defaults to $TTY7_WORKTREE_ID.")
    var worktree: String?

    @Option(name: [.short, .long], help: "Tab ID. Defaults to $TTY7_TAB_ID.")
    var tab: String?
  ...
  struct Focus: ParsableCommand {
    ...
    @Option(name: [.short, .long], help: "Surface ID. Defaults to $TTY7_SURFACE_ID.")
    var surface: String?
