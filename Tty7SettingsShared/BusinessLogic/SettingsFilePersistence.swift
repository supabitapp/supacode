...
public nonisolated enum SettingsFileURLKey: DependencyKey {
  public static var liveValue: URL { Tty7Paths.settingsURL }
  public static var previewValue: URL { Tty7Paths.settingsURL }
  public static var testValue: URL { Tty7Paths.settingsURL }
}
