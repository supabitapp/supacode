...
extension Worktree {
  /// Base environment variables for tty7 scripts (supplemented per-surface).
  var scriptEnvironment: [String: String] {
    [
      "TTY7_WORKTREE_PATH": workingDirectory.path(percentEncoded: false),
      "TTY7_ROOT_PATH": repositoryRootURL.path(percentEncoded: false),
    ]
  }
