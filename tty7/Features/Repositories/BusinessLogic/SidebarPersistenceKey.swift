...
/// from and writes to. Production wires to `Tty7Paths.sidebarURL`;
...
public nonisolated enum SidebarFileURLKey: DependencyKey {
  public static var liveValue: URL { Tty7Paths.sidebarURL }
  public static var previewValue: URL { Tty7Paths.sidebarURL }
  public static var testValue: URL {
    FileManager.default.temporaryDirectory
      .appending(
        path: "tty7-sidebar-test-\(UUID().uuidString).json",
