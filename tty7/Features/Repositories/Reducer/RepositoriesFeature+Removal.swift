...
extension RepositoriesFeature {
  ...
  /// are repo-level and drop the whole section from tty7, with
...
extension RepositoriesFeature {
  ...
  func confirmationAlertForRepositoryRemoval(
    ...
    return AlertState {
      ...
      TextState(
        isGitRepository
          ? "This removes the repository from tty7. "
            + "The repository and its worktrees stay on disk."
          : "This removes the folder from tty7. The folder stays on disk."
      )
    }
  }
