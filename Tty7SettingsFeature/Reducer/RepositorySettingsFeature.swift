...
public struct RepositorySettingsFeature {
  ...
  public var body: some Reducer<State, Action> {
    ...
    Reduce { state, action in
      ...
      case .settingsLoaded(
        ...
        updatedSettings.worktreeBaseDirectoryPath = Tty7Paths.normalizedWorktreeBaseDirectoryPath(
        ...
        state.globalDefaultWorktreeBaseDirectoryPath =
          Tty7Paths.normalizedWorktreeBaseDirectoryPath(globalDefaultWorktreeBaseDirectoryPath)
  ...
  private func persistAndNotify(state: inout State) -> Effect<Action> {
    ...
    normalizedSettings.worktreeBaseDirectoryPath = Tty7Paths.normalizedWorktreeBaseDirectoryPath(
