...
struct DeeplinkClientTests {
  ...
  @Test func emptyURLReturnsOpen() {
    let url = URL(string: "tty7://")!
    #expect(parse(url) == .open)
  }

  @Test func helpURLReturnsHelp() {
    let url = URL(string: "tty7://help")!
  ...
  @Test func worktreeTabDestroy() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let tabUUID = UUID(uuidString: "550E8400-E29B-41D4-A716-446655440000")!
    let url = URL(string: "tty7://worktree/\(encoded)/tab/\(tabUUID.uuidString)/destroy")!
  ...
  @Test func worktreeSurfaceFocus() {
    ...
    let url = URL(
      string: "tty7://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/\(surfaceUUID.uuidString)"
    )!
    #expect(
      parse(url)
  ...
  @Test func worktreeSurfaceFocusWithInput() {
    ...
    let surfaceUUID = UUID(uuidString: "660E8400-E29B-41D4-A716-446655440000")!
    let url = URL(
      string: "tty7://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/\(surfaceUUID.uuidString)?input=ls"
    )!
    #expect(
      parse(url)
  ...
  @Test func worktreeSurfaceSplitHorizontal() {
    ...
    let tabUUID = UUID(uuidString: "550E8400-E29B-41D4-A716-446655440000")!
    let surfaceUUID = UUID(uuidString: "660E8400-E29B-41D4-A716-446655440000")!
    let base = "tty7://worktree/\(encoded)/tab/\(tabUUID.uuidString)"
  ...
  @Test func worktreeSurfaceSplitDefaultsToHorizontal() {
    ...
    let url = URL(
      string:
        "tty7://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/\(surfaceUUID.uuidString)/split"
    )!
    #expect(
      parse(url)
        == .worktree(
  ...
  @Test func worktreeSurfaceInvalidUUIDReturnsNil() {
    ...
    let tabUUID = UUID(uuidString: "550E8400-E29B-41D4-A716-446655440000")!
    let url = URL(
      string: "tty7://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/not-a-uuid"
    )!
    #expect(parse(url) == nil)
  }
  ...
  @Test func repoWorktreeNewWithBranch() {
    ...
    let url = URL(
      string: "tty7://repo/\(repoEncoded)/worktree/new?branch=feature-x&base=main&fetch=true"
    )!
    #expect(
      parse(url)
        == .repoWorktreeNew(
  ...
  @Test func repoWorktreeNewWithNameAndLocation() {
    ...
    let url = URL(
      string:
        "tty7://repo/\(repoEncoded)/worktree/new?branch=feature%2Ffoo&name=feature_foo&location=%7E%2FRepos"
    )!
    #expect(
      parse(url)
        == .repoWorktreeNew(
  ...
  @Test func repoWorktreeNewWithoutBranch() {
    let repoEncoded = "%2Ftmp%2Frepo"
    let url = URL(string: "tty7://repo/\(repoEncoded)/worktree/new")!
    #expect(
      parse(url)
        == .repoWorktreeNew(
          repositoryID: "/tmp/repo",
  ...
  @Test func repoUnknownPathReturnsNil() {
    let repoEncoded = "%2Ftmp%2Frepo"
    let url = URL(string: "tty7://repo/\(repoEncoded)/unknown")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeTabNewWithID() {
    ...
    let url = URL(string: "tty7://worktree/\(encoded)/tab/new?id=\(tabID.uuidString)")!
  ...
  @Test func repoOpenWithEmptyPathReturnsNil() {
    let url = URL(string: "tty7://repo/open?path=")!
    #expect(parse(url) == nil)
  }

  @Test func repoOpenWithRelativePathReturnsNil() {
    let url = URL(string: "tty7://repo/open?path=relative/path")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeStop() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "tty7://worktree/\(encoded)/stop")!
  ...
  @Test func worktreeScriptRun() {
    ...
    let url = URL(string: "tty7://worktree/\(encoded)/script/\(scriptID.uuidString)/run")!
    #expect(
      parse(url)
  ...
  @Test func worktreeScriptStop() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let scriptID = UUID(uuidString: "AA0E8400-E29B-41D4-A716-446655440000")!
    let url = URL(string: "tty7://worktree/\(encoded)/script/\(scriptID.uuidString)/stop")!
    #expect(
      parse(url)
  ...
  @Test func worktreeScriptInvalidUUIDReturnsNil() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "tty7://worktree/\(encoded)/script/not-a-uuid/run")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeScriptUnknownVerbReturnsNil() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let scriptID = UUID(uuidString: "AA0E8400-E29B-41D4-A716-446655440000")!
    let url = URL(string: "tty7://worktree/\(encoded)/script/\(scriptID.uuidString)/explode")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeScriptMissingVerbReturnsNil() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let scriptID = UUID(uuidString: "AA0E8400-E29B-41D4-A716-446655440000")!
    let url = URL(string: "tty7://worktree/\(encoded)/script/\(scriptID.uuidString)")!
    #expect(parse(url) == nil)
  }

  @Test func worktreeScriptMissingIDReturnsNil() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "tty7://worktree/\(encoded)/script")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeWithNoIDReturnsNil() {
    let url = URL(string: "tty7://worktree")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func unknownHostReturnsNil() {
    let url = URL(string: "tty7://unknown/something")!
    #expect(parse(url) == nil)
  }
}
